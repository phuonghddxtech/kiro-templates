---
name: systems-design
description: System design patterns, scalability principles, caching strategies, database scaling, and reliability patterns. Invoke when designing architecture, choosing patterns, or planning for scale.
---

# System Design Skill

> Based on "System Design Interview" (Alex Xu) and "Designing Data-Intensive Applications" (Martin Kleppmann).
...
- **CP** (sacrifice availability): MySQL, ZooKeeper → use when data correctness is critical
- **AP** (sacrifice consistency): Cassandra, DynamoDB → use for high availability
...
- Tasks are slow/expensive (email, PDF, notifications)
