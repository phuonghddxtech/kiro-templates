...
description: Skill to perform a thorough security audit of the codebase. Invoke when auditing security before a release, reviewing a PR for vulnerabilities, or investigating a security incident.
---
