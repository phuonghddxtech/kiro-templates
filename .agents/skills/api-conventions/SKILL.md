...
description: REST API design standards including URL structure, HTTP methods, status codes, response format, pagination, and documentation. Invoke when designing or reviewing API endpoints.
---

# API Conventions Skill

> Standard REST API design rules for all projects.
